...
<div class="container-fluid">
 ...
 <div class="col-sm-12 col-md-12 col-lg-12" id="top_bar">
  ...
  <form method="GET" action="women.php">
<button class="btn-small btn-success" name="go" style="padding:4px"><span class="glyphicon glyphicon-home">
         
</span>Home</button>

<button class='btn btn-danger pull-right ' onclick=window.print(); style='margin-top:20px'>
