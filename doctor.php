...
<div class="panel-heading " style="background-color:rgb(51, 192, 51)" >
 <h2> OVERVIEW</h2>
 <hr/>
 <b style="padding:10px">Dr.<?php echo $_SESSION['name']; ?><b>
</div>
...
<li><span class="glyphicon glyphicon-pencil" style="background-color:rgb(51, 192, 51)" >
</span><a href="home.php">change Password</a><hr/></li>
